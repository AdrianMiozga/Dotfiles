...
pitchproof = reaper.TrackFX_GetByName(selectedTrack, "PitchProof", false)
reapitch = reaper.TrackFX_GetByName(selectedTrack, "ReaPitch", false)
trackNumSends = reaper.GetTrackNumSends(selectedTrack, 0)
